...
if combo.get() == "BINÁRIO":
    # ocatal
    l_octal = Label(frame_baixo, text="OCATAL", width=12, relief=FLAT, anchor='nw', font=('Verdana 13'), bg=co5, fg=co1)
    l_octal.place(x=35, y=60)
    l_octal = Label(frame_baixo, text="", width=13, relief=FLAT, anchor='center', font=('Verdana 13'), fg=co4)
    l_octal.place(x=170, y=60)
